...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-07-2025 a las 17:57:31
...
--
-- Estructura de tabla para la tabla `tipos_movimiento_almacen`
--

CREATE TABLE `tipos_movimiento_almacen` (
  `id_tipo` int(11) NOT NULL,
...
ALTER TABLE `almacen`
  ...
  ADD KEY `fk_almacen_categoria` (`id_categoria`);
...
ALTER TABLE `equipos`
  ...
  ADD KEY `id_responsable` (`id_responsable`),
  ADD KEY `fk_equipos_categoria` (`id_categoria`);
...
--
-- Indices de la tabla `tipos_movimiento_almacen`
--
ALTER TABLE `tipos_movimiento_almacen`
...
--
-- AUTO_INCREMENT de la tabla `tipos_movimiento_almacen`
--
ALTER TABLE `tipos_movimiento_almacen`
...
--
ALTER TABLE `almacen`
  ADD CONSTRAINT `fk_almacen_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categorias_almacen` (`id_categoria`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `bitacora`
  ADD CONSTRAINT `bitacora_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
...
ALTER TABLE `equipos`
  ...
  ADD CONSTRAINT `fk_equipos_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categorias_equipos` (`id_categoria`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `historial_asignaciones`
  ADD CONSTRAINT `historial_asignaciones_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipos` (`id_equipo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historial_asignaciones_ibfk_2` FOREIGN KEY (`id_responsable`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historial_asignaciones_ibfk_3` FOREIGN KEY (`id_asignador`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `movimientos_almacen`
  ADD CONSTRAINT `fk_item` FOREIGN KEY (`id_item`) REFERENCES `almacen` (`id_item`),
  ADD CONSTRAINT `fk_responsable_mov` FOREIGN KEY (`id_responsable`) REFERENCES `user` (`id_user`),
  ADD CONSTRAINT `fk_tipo_mov` FOREIGN KEY (`id_tipo`) REFERENCES `tipos_movimiento_almacen` (`id_tipo`),
  ADD CONSTRAINT `fk_usuario_mov` FOREIGN KEY (`id_usuario`) REFERENCES `user` (`id_user`),
