...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2025 a las 05:06:32
...
--
ALTER TABLE `historial_asignaciones`
  ADD CONSTRAINT `historial_asignaciones_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipos` (`id_equipo`),
  ADD CONSTRAINT `historial_asignaciones_ibfk_2` FOREIGN KEY (`id_responsable`) REFERENCES `user` (`id_user`),
  ADD CONSTRAINT `historial_asignaciones_ibfk_3` FOREIGN KEY (`id_asignador`) REFERENCES `user` (`id_user`);
